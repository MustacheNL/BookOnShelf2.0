...
while($row = $result->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo "<tr>
        ...
        <td>$releasedate</td>
        <td>$info</td>
        <td><a href=\"/index.php?page=boekenlijst&hire=$id\"> <button class='btn-default'type=\"submit\" form=\"form1\" value=\"$id\" onclick=\"return confirm('weet je zeker dat je boek het boek wilt lenen?')\"><strong>$name huren</strong></button></a></td>
        </tr>";
}
